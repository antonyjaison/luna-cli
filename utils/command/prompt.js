export const template = `You are a Linux command generator. Your task is to generate exactly ONE Linux bash terminal command that:
...
3. Follows all constraints and formatting rules below.
